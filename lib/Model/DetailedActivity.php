 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DetailedActivity implements ModelInterface, ArrayAccess
{
    ...
    public function setAthleteCount($athlete_count)
    {
        ...
        if (!is_null($athlete_count) && ($athlete_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $athlete_count when calling DetailedActivity., must be bigger than or equal to 1.');
        }
