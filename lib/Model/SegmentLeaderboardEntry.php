...
/**
 * SegmentLeaderboardEntry Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SegmentLeaderboardEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SegmentLeaderboardEntry';
    ...
    {
        $this->container['athlete_name'] = isset($data['athlete_name']) ? $data['athlete_name'] : null;
    ...
    {
        return $this->container['athlete_name'];
    }

    /**
     * Sets athlete_name
     *
     * @param string $athlete_name The public name of the athlete
     *
     * @return $this
     */
    public function setAthleteName($athlete_name)
    {
        $this->container['athlete_name'] = $athlete_name;
     ...
     * Sets elapsed_time
     *
     * @param int $elapsed_time The elapsed of the segment effort associated with this entry
     *
     * @return $this
     */
     ...
     * Sets moving_time
     *
     * @param int $moving_time The moving of the segment effort associated with this entry
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param int $rank The rank of this entry in the leaderboard
     *
     * @return $this
     */
