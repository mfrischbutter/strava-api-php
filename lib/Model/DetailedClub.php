 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DetailedClub implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['membership'], $allowedValues)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getMembershipAllowableValues();
        if (!is_null($membership) && !in_array($membership, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'membership', must be one of '%s'",
                    implode("', '", $allowedValues)
